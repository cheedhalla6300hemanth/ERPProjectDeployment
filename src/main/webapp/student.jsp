...
.dropdown-menu.show + .nav-link .caret {
    ...
    #moreDropdown {
        top: 40px; /* Adjust this value to match the navbar height */
        right: 0;
    }
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-custom">
        ...
        <span class="navbar-text">Student-Portal</span>
    </div>
        <div class="student-info">
            <img src="displaystudentimage?sid=<%=student.getSid() %>" alt="Student Image" >
            <span><%=student.getSname() %></span>
            <a href="logoutu" class="logout-link">Logout</a>
           
<!--          more option \ ki edhi choose chesu kovali and paina styles lo last undhi and kindhi js code kuda vundhi chusoko
 -->    
         <a class="nav-link" href="#" id="moreToggle">
            ...
            <ul class="dropdown-menu" id="moreDropdown">
                ...
                <li><a class="logout-link" href="logoutu">Logout</a></li>
                 <li><a class="dropdown-item" href="deletestudents">Delete Students</a></li>
    ...
    <div class="sidebar">
        <ul class="navbar-nav">
            ...
            <li><a class="nav-link" href="studenthome">Home</a></li>
          <li><a class="nav-link" href="studentprofile">Profile</a></li>
          <li><a class="nav-link" href="selectfortt">Course Registration</a></li>
                
            <li><a class="nav-link" href="sforgetpassword">Reset Password</a></li>
            <li><a class="nav-link" href="contactus">Feed Back</a></li>
            <li><a class="nav-link" href="updatestudent">Edit Profile</a></li>
