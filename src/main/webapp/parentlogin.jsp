...
<body>
    ...
    <div class="form-container">
        <h1>Parent Login</h1>
        <form action="checkparentlogin" method="post">
         <div class="mb-3">
                
                <input type="text" class="form-control" id="semail" name="semail" placeholder="Enter Child Email" required>
            </div>
            <div class="mb-3">
                
                <input type="text" class="form-control" id="pusername" name="pusername" placeholder="Enter username" required>
            </div>
            <div class="mb-3">
              
                <input type="password" class="form-control" id="ppassword" name="ppassword" placeholder="Enter password" required>
            </div>
            <button type="submit" class="btn btn-custom">Login</button>
        </form>
        <div class="links">
            <a href="parentregister">Register</a> | <a href="pforgetpassword">Forgot Password?</a>
