           ...
           <tr>
            ...
            <c:forEach items="${facultylist}" var="faculty">
                <tr>
                    ...
                    <td>
                    <a href='<c:url value="updatestatusf?fid=${faculty.fid}&fstatus=Accepted"></c:url>'>Accept</a>
                    <a href='<c:url value="updatestatusf?fid=${faculty.fid}&fstatus=Rejected"></c:url>'>Reject</a>
               </td>
            </c:forEach>
        </table>
    </div>
